...
public class BookControllerTest {
    ...
    @Before
    public void init() {
        Book book = new Book(1L, "Book Name", "Cts", new BigDecimal("9.99"));
   ...
   /* @Test
    public void find_allBook_OK() throws Exception {
        ...
        mockMvc.perform(get("/books"))
                ...
                .andExpect(jsonPath("$[0].price", is(1.90)))
    ...
    public void save_book_OK() throws Exception {
        ...
        Book newBook = new Book(1L, "Spring Boot Guide", "Cts", new BigDecimal("2.99"));
    ...
    public void update_book_OK() throws Exception {
        ...
        Book updateBook = new Book(1L, "ABC", "Cts", new BigDecimal("19.99"));
